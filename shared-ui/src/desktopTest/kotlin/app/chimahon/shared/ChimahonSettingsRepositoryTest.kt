...
class ChimahonSettingsRepositoryTest {
    ...
    fun persistsEverySettingsGroupAcrossRepositoryInstances() = runBlocking {
        ...
        val appearance = ChimahonAppearanceSettings(
            ...
            appTheme = ChimahonAppTheme.Custom,
        ...
        val reader = ChimahonReaderSettings(
            ...
            orientation = ChimahonReaderOrientation.Landscape,
            dualPageMode = ChimahonDualPageMode.Always,
            splitWidePages = true,
            ...
            brightness = -15,
            showPageStrip = false,
            forceHorizontalSeekbar = true,
            landscapeVerticalSeekbar = false,
            leftVerticalSeekbar = true,
            ...
            readWithLongTap = false,
            keepScreenOn = true,
            fullscreen = false,
            drawUnderCutout = true,
            doubleTapAnimationSpeedMillis = 250,
            navigationMode = ChimahonReaderNavigationMode.Vertical,
            ocrOutlineVisible = true,
            cropBorders = true,
            pageTransitions = false,
            eInkSwipeSensitivity = true,
            flashOnPageChange = true,
            flashDurationMillis = 700,
            flashPageInterval = 3,
            flashColor = ChimahonReaderFlashColor.Black,
            ...
            preloadSize = 9,
            readerThreads = 4,
            readerCacheSizeMb = 500,
            aggressivePageLoading = true,
            preserveReadingPosition = false,
            useAutoWebtoon = true,
            invertDoublePages = true,
            centerMarginDp = 12,
            pagedZoomStart = ChimahonReaderZoomStart.Right,
            landscapeZoom = false,
            landscapeZoomType = ChimahonReaderLandscapeZoomType.Double,
            pagedDisableZoomIn = true,
            webtoonScaleType = ChimahonWebtoonScaleType.SixteenNine,
            smartLongStripGapScale = true,
            webtoonSidePaddingPercent = 20,
            webtoonReaderHideThreshold = ChimahonReaderHideThreshold.Highest,
            webtoonPinchToZoom = false,
            webtoonDisableZoomOut = true,
            continuousVerticalTappingByPage = true,
            ocrAutoOnDownload = true,
            bottomButtons = listOf("vc", "br", "sh", "rm", "rot", "cbw"),
        )
        ...
        val browse = ChimahonBrowseSettings(
            ...
            autoLoadMore = false,
            enabledLanguages = listOf("en", "ja"),
            sourceDisplayMode = ChimahonBrowseSourceDisplayMode.Grid,
            groupSourcesByLanguage = false,
            showSourceLanguage = false,
            extensionUpdateNotificationsEnabled = false,
            relatedMangaRecommendations = false,
            expandRelatedMangaSections = false,
            relatedMangaInOverflow = true,
            showHomeInRelatedManga = false,
            sourceCategoriesFilter = true,
            useNewSourceNavigation = false,
            allowLocalSourceHiddenFolders = true,
            hideFeedTab = true,
            feedTabInFront = true,
            hideLibraryFeedEntries = true,
        )
